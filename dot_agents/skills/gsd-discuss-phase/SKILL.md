...
Read and execute `$HOME/.codex/gsd-core/workflows/list-phase-assumptions.md` end-to-end.
Stop here.

Otherwise, if `DISCUSS_MODE` is `"assumptions"`:
Read and execute `$HOME/.codex/gsd-core/workflows/discuss-phase-assumptions.md` end-to-end.

Otherwise (`"discuss"` / unset / any other value):
Read and execute `$HOME/.codex/gsd-core/workflows/discuss-phase.md` end-to-end.
