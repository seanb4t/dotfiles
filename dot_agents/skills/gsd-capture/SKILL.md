...
<execution_context>
@$HOME/.codex/gsd-core/workflows/add-todo.md
@$HOME/.codex/gsd-core/workflows/note.md
@$HOME/.codex/gsd-core/workflows/add-backlog.md
@$HOME/.codex/gsd-core/workflows/plant-seed.md
@$HOME/.codex/gsd-core/workflows/check-todos.md
@$HOME/.codex/gsd-core/workflows/list-seeds.md
