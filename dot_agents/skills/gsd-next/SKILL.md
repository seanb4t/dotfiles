...
<execution_context>
@$HOME/.codex/gsd-core/workflows/smart-entry.md
...
<process>
Follow $HOME/.codex/gsd-core/workflows/smart-entry.md. Detect the situation, present the menu, and dispatch exactly one command. Then stop.
</process>
